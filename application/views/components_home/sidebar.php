<div class="container-fluid">
    ...
    <div id="sidebar" class="align-items-center">
        ...
        <ul>
            ...
            <li><a class="js-scrollTo sub-title" href="#page-projects"> Mes projets </a></li>
            ...
            <li class="row justify-content-center">
                ...
                <a class="sub-title github px-4" href="https://github.com/EliottClavier" target="_blank">
                    <i class="fab fa-github fa-sm"></i>
                </a>

                <a class="sub-title phone-trigger px-4" style="cursor: pointer">
